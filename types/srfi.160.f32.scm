...
((group
   ((name . "f32vector-take-while")
    (signature lambda ((predicate pred?) (f32vector? f32vec)) f32vector?)
    (tags pure))
...
((name . "f32vector-partition")
 (signature
   lambda
   ((predicate pred?) (f32vector? f32vec))
...
((group
   ((name . "f32vector-filter")
    (signature lambda ((predicate pred?) (f32vector? f32vec1)) f32vector?)
    (tags pure))
...
((name . "f32vector-swap!")
 (signature lambda ((f32vector? f32vec) (integer? i) (integer? j)) undefined)
 (desc . "Interchanges the ith and jth elements of f32vec."))
((name . "f32vector-fill!")
 (signature
   case-lambda
