...
((group
   ((name . "c128vector-take-while")
    (signature lambda ((predicate pred?) (c128vector? c128vec)) c128vector?)
    (tags pure))
...
((name . "c128vector-partition")
 (signature
   lambda
   ((predicate pred?) (c128vector? c128vec))
...
((group
   ((name . "c128vector-filter")
    (signature lambda ((predicate pred?) (c128vector? c128vec1)) c128vector?)
    (tags pure))
