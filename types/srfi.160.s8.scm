...
((group
   ((name . "s8vector-take-while")
    (signature lambda ((predicate pred?) (s8vector? s8vec)) s8vector?)
    (tags pure))
...
((group
   ((name . "s8vector-filter")
    (signature lambda ((predicate pred?) (s8vector? s8vec1)) s8vector?)
    (tags pure))
...
((name . "s8vector-swap!")
 (signature lambda ((s8vector? s8vec) (integer? i) (integer? j)) undefined)
 (desc . "Interchanges the ith and jth elements of s8vec."))
((name . "s8vector-fill!")
 (signature
   case-lambda
