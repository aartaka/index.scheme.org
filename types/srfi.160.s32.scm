...
((group
   ((name . "s32vector-take-while")
    (signature lambda ((predicate pred?) (s32vector? s32vec)) s32vector?)
    (tags pure))
...
((name . "s32vector-partition")
 (signature
   lambda
   ((predicate pred?) (s32vector? s32vec))
...
((group
   ((name . "s32vector-filter")
    (signature lambda ((predicate pred?) (s32vector? s32vec1)) s32vector?)
    (tags pure))
...
((name . "s32vector-swap!")
 (signature lambda ((s32vector? s32vec) (integer? i) (integer? j)) undefined)
 (desc . "Interchanges the ith and jth elements of s32vec."))
((name . "s32vector-fill!")
 (signature
   case-lambda
