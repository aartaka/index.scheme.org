...
Essentially lifts proc from a char->char procedure to a char-set -> char-set procedure."))
 ...
 ((group ((name . "list->char-set")
  ...
  (desc . "Return a character set containing the characters in the list of characters char-list.
 ...
 ((group ((name . "string->char-set")
  ...
  (desc . "Return a character set containing the characters in the string s.
 ...
 ((group ((name . "ucs-range->char-set")
         ...
         ((name . "ucs-range->char-set!")
          (signature
           ...
           ((integer? lower) (integer? upper) (boolean? error?) (char-set? base-cs))
           char-set?)))
  (desc . "Lower and upper are exact non-negative integers; lower <= upper.
