...
In all cases, two values are returned: the possibly updated set and obj."))
 ...
 ((name . "set-find")
  (signature lambda ((predicate predicate) (set? set) (procedure? failure)) *)
  (subsigs
   (failure (lambda () *)))
  (tags pure)
 ...
 ((name . "set-count")
  (signature lambda ((predicate predicate) (set? set)) integer?)
  (tags pure)
  (desc . "Returns the number of elements of set that satisfy predicate as an exact integer."))
 ((name . "set-any?")
  (signature lambda ((predicate predicate) (set? set)) boolean?)
  (tags pure)
...
Note that, when proc defines a mapping that is not 1:1, some of the mapped objects may be equivalent in the sense of comparator's equality predicate, and in this case duplicate elements are omitted as in the set constructor."))
 ...
 ((name . "set-filter")
  (signature lambda ((predicate predicate) (set? set)) set?)
  (tags pure)
 ...
 ((name . "set-partition")
  (signature lambda ((predicate predicate) (set? set)) (values set? set?))
  (tags pure)
...
In all cases, two values are returned: the possibly updated bag and obj."))
 ...
 ((name . "bag-find")
  (signature lambda ((predicate predicate) (bag? bag) (procedure? failure)) *)
  (subsigs
   (failure (lambda () *)))
  (tags pure)
 ...
 ((name . "bag-count")
  (signature lambda ((predicate predicate) (bag? bag)) integer?)
  (tags pure)
  (desc . "Returns the number of elements of bag that satisfy predicate as an exact integer."))
 ((name . "bag-any?")
  (signature lambda ((predicate predicate) (bag? bag)) boolean?)
  (tags pure)
...
Note that, when proc defines a mapping that is not 1:1, some of the mapped objects may be equivalent in the sense of comparator's equality predicate, and in this case duplicate elements are omitted as in the bag constructor."))
 ...
 ((name . "bag-filter")
  (signature lambda ((predicate predicate) (bag? bag)) bag?)
  (tags pure)
 ...
 ((name . "bag-partition")
  (signature lambda ((predicate predicate) (bag? bag)) (values bag? bag?))
  (tags pure)
