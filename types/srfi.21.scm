(((name . "current-thread")
 ...
 ((name . "thread-base-priority")
  ...
  (tags pure)
  (desc . "Returns a real number which corresponds to the base priority of the thread."))
 ((name . "thread-base-priority-set!")
  (signature lambda ((thread? thread) (real? priority)) undefined)
  (desc . "Changes the base priority of the thread to priority. The priority must be a real number. thread-base-priority-set! returns an unspecified value."))
 ((name . "thread-priority-boost")
  (signature lambda ((thread? thread)) real?)
  (tags pure)
  (desc . "Returns a real number which corresponds to the priority boost of the thread."))
 ((name . "thread-priority-boost-set!")
  (signature lambda ((thread? thread) (real? priority-boost)) undefined)
  (desc . "Changes the priority boost of the thread to priority-boost. The priority-boost must be a non-negative real. thread-priority-boost-set! returns an unspecified value."))
 ((name . "thread-quantum")
  (signature lambda ((thread? thread)) real?)
  (tags pure)
  (desc . "Returns a real number which corresponds to the quantum of the thread."))
 ((name . "thread-quantum-set!")
  (signature lambda ((thread? thread) (real? quantum)) undefined)
  (desc . "Changes the quantum of the thread to quantum. The quantum must be a non-negative real. A value of zero selects the smallest quantum supported by the implementation. thread-quantum-set! returns an unspecified value."))
 ((name . "thread-start!")
  (signature lambda ((thread? thread)) thread?)
