...
The equality procedure must be consistent with eq?. Note that this implies that two ideques which are eq? are always ideque=, as well; implementations may exploit this fact to \"short-cut\" the element-by-element comparisons."))
 ((name . "ideque-any")
  (signature lambda ((predicate pred) (ideque? ideque)) *)
  (tags pure)
 ...
 ((name . "ideque-count")
  (signature lambda ((predicate pred) (ideque? ideque)) integer?)
  (tags pure)
 ...
 ((name . "ideque-filter")
  (signature lambda ((predicate pred) (ideque? ideque)) ideque?)
  (tags pure)
 ...
 ((name . "ideque-find")
  (signature
   case-lambda
   (((predicate pred) (ideque? ideque)) *)
   (((predicate pred) (ideque? ideque) (procedure? failure)) *))
  (subsigs
   (failure (lambda () *)))
  (tags pure)
