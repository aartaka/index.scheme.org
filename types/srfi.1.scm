(((name . "cons")
 ...
 ((group ((name . "car") (signature lambda ((pair? pair)) *) (tags pure))
         ((name . "cdr") (signature lambda ((pair? pair)) *) (tags pure)))
  (desc . "These functions return the contents of the car and cdr field of their argument, respectively. Note that it is an error to apply them to the empty list."))
 ((group ((name . "caar") (signature lambda ((pair? pair)) *) (tags pure))
 ...
 ((group ((name . "split-at")
         ...
         ((name . "split-at!")
          (signature
           ...
           (((circular-list? x) (integer? i)) (values list? circular-list?))
           (((dotted-list? x) (integer? i)) (values list? *)))))
  (desc . "split-at splits the list x at index i, returning a list of the first i elements, and the remaining tail. It is equivalent to (values (take x i) (drop x i)). split-at! is the linear-update variant. It is allowed, but not required, to alter the argument list to produce the result."))
 ((group ((name . "last")
          (signature lambda ((list? pair)) *)
          (tags pure))
         ((name . "last-pair")
          (signature lambda ((list? pair)) pair?)
          (tags pure)))
  (desc . "last returns the last element of the non-empty, finite list pair. last-pair returns the last pair in the non-empty, finite list pair."))
 ((group ((name . "length")
 ...
 ((name . "unfold")
  (signature
   ...
   (((predicate stop?) (procedure? mapper) (procedure? successor) seed (list? tail-gen)) *))
  (subsigs
   (mapper (lambda (seed) *))
 ...
 ((group ((name . "filter!")
         ...
         ((name . "remove!")
          (signature lambda ((predicate pred) (list? list)) list?)))
  (desc . "Linear-update variants of filter, partition and remove. These procedures are allowed, but not required, to alter the cons cells in the argument list to construct the result lists."))
 ((name . "find")
 ...
 ((name . "find-tail")
  (signature lambda ((predicate pred) (list? list)) (or pair? #f))
  (tags pure)
 ...
 ((group ((name . "take-while")
          (signature lambda ((predicate pred) (list? list)) list?)
          (tags pure))
         ((name . "take-while!")
          (signature lambda ((predicate pred) (list? list)) list?)))
  (desc . "Returns the longest initial prefix of clist whose elements all satisfy the predicate pred. Take-while! is the linear-update variant. It is allowed, but not required, to alter the argument list to produce the result."))
 ((name . "drop-while")
  (signature
   case-lambda
   (((predicate pred) (list? list)) list?)
   (((predicate pred) (circular-list? list)) circular-list?))
  (tags pure)
 ...
 ((group ((name . "span")
          (signature
           case-lambda
           (((predicate pred) (list? list)) (values list? list?))
           (((predicate pred) (circular-list? list)) (values list? circular-list?)))
          (tags pure))
         ((name . "span!")
          (signature lambda ((predicate pred) (list? list)) (values list? list?)))
         ((name . "break")
 ...
 ((name . "alist-copy")
  (signature lambda ((list? alist)) list?)
  (tags pure)
  (desc . "Make a fresh copy of alist. This means copying each pair that forms an association as well as the spine of the list."))
 ((group ((name . "alist-delete")
          (signature
           case-lambda
           ((key (list? alist)) list?)
