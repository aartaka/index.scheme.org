...
((group
   ((name . "u16vector-take-while")
    (signature lambda ((predicate pred?) (u16vector? u16vec)) u16vector?)
    (tags pure))
...
((name . "u16vector-partition")
 (signature
   lambda
   ((predicate pred?) (u16vector? u16vec))
...
((group
   ((name . "u16vector-filter")
    (signature lambda ((predicate pred?) (u16vector? u16vec1)) u16vector?)
    (tags pure))
...
((name . "u16vector-swap!")
 (signature lambda ((u16vector? u16vec) (integer? i) (integer? j)) undefined)
 (desc . "Interchanges the ith and jth elements of u16vec."))
((name . "u16vector-fill!")
 (signature
   case-lambda
