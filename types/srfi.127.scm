...
If none of the lseqs are finite, lseq-for-each never returns."))
 ((name . "lseq-filter")
  (signature lambda ((predicate pred) (lseq? lseq)) lseq?)
  (tags pure)
 ...
 ((name . "lseq-find")
  (signature lambda ((predicate pred) (lseq? lseq)) *)
  (tags pure)
 ...
 ((name . "lseq-find-tail")
  (signature lambda ((predicate pred) (lseq? lseq)) (or #f lseq?))
  (tags pure)
 ...
 ((name . "lseq-any")
  (signature lambda ((predicate pred) (lseq? lseq1) (lseq? lseq2) ...) *)
  (tags pure)
 ...
 ((name . "lseq-index")
  (signature
   lambda
   ((predicate pred) (lseq? lseq1) (lseq? lseq2) ...)
   (or integer? #f))
  (tags pure)
